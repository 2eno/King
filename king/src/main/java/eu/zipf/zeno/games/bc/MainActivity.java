...
public class MainActivity extends Activity implements View.OnClickListener {
  ...
  // Leben, Energie und Siegespunkte
  public static int[] mParticipantScore = new int[3];
  ...
  public static byte[] mMsgBuf = new byte[3];
  ...
  void startQuickGame() {
    ...
    mRoomConfig = RoomConfig.builder(mRoomUpdateCallback)
            .setOnMessageReceivedListener(eu.zipf.zeno.games.bc.Multiplayer.mOnRealTimeMessageReceivedListener)
  ...
  void resetGameVars() {
    ...
    mScore = 0;
    mParticipantScore = null;
    eu.zipf.zeno.games.bc.Multiplayer.mFinishedParticipants.clear();
  }

  // Start the gameplay phase of the game.
  void startGame() {
    UpdateUI.updateScoreDisplay();
    eu.zipf.zeno.games.bc.Multiplayer.broadcastScore(10,0,0);
    UpdateUI.switchToScreen(R.id.screen_game);
